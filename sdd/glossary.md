...
| **MiniCollage** | A compact variant of the Scroll Collage component used for inline photo strips within editorial sections and apartment detail pages. Same CSS marquee technique but smaller scale, configurable speed, and intended for contextual photo galleries within content sections. |
