...
- All images served via Worker route (`/api/img/{key}`, descriptive slug or UUID keys) with Cloudflare Image Resizing (`cf: { image }`) — private R2, AVIF/WebP with JPEG fallback, responsive widths
