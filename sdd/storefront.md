...
- **Status:** Implemented — 138 real island photos in alternating scrolling collage strips (14 strips); locale-specific intro text in all 4 locales; locale-seeded deterministic shuffle for per-language visual variety; 50 poetic Croatian captions rendered as visible sans-serif overlay text on photos (via `showCaptions`) and used as alt text; fixed 80s scroll speed per strip; zero stock photos
