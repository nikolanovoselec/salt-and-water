...
| `hrana` | ~16 (4 × 4 locales) | Food & Drink page content rows. Each entry: `sort_order`, `locale`, `title`, `body`, `image`, `gallery`. |
| `aktivnosti` | ~16 (4 × 4 locales) | Nature & Activities page content rows. Same schema as `hrana`. |
| `plaze` | ~16 (4 × 4 locales) | Beaches page content rows. Same schema as `hrana`. |
| `dolazak` | ~12 (3 × 4 locales) | Getting Here page content rows. Same schema as `hrana`. |
